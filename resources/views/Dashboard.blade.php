<html>
    <head>
        ...
        <script src='{{ env('IMG') }}/chart.js'></script>
        <script
              src="{{ env('IMG') }}/jquery.js"
    ...
    <body class='flex flex-col bg-gray-300 justify-between duration-700'>
        <div class='flex flex-row justify-between bg-white shadow-md duration-700 rounded-xl p-5'>
            <div class="flex flex-row justify-start">
                <a href="{{ url('/profile') }}" class='ml-5 hover:opacity-60'><img src='{{ env("IMG") }}/icons/pengelola.png' class='w-10' /></a>
            </div>

            <div class='flex flex-end'>
                @if( $role == 'admin' )
                    <a href='{{ url('/register') }}'><img src='{{ env('IMG') }}/icons/register.png' class="w-8 mr-8 hover:opacity-70" /></a>
                @endif
                <a href='{{ url('/logout') }}' class='hover:opacity-70'><img src='{{ env('IMG') }}/icons/logout.png' class='w-8 mr-4' /></a>
            </div>
        </div>

        <div class='flex flex-col justify-between'>
            <a href='{{ url('/') }}' class='place-self-center mt-5'><img src='{{ env("IMG") }}/icons/box.png' class='w-16 h-16 place-self-center mt-5 hover:bg-white duration-700 rounded-xl' /></a>
            ...
            <div class="flex flex-row mt-8 justify-center duration-700">
                ...
                <div class='flex flex-col bg-white p-12 shadow-md ml-20 rounded-xl hover:opacity-60 duration-700 cursor-pointer items-center'>
                    <Img src='{{ env('IMG') }}/icons/kategori.png' class='w-12 ml-2' />
