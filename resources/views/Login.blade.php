...
<body class='flex flex-col bg-gray-300 justify-between'>
    ...
    <div class='flex place-self-center justify-center mt-4 items-center'>
        <form action='/' method='post' class='flex flex-col place-self-center bg-white p-5 mt-5 shadow-xl rounded-xl'>
            @csrf
            ...
            <p class='mt-5'>Belum punya akun ? register di <a href='/register' class='text-blue-800'>sini</a></p>
            @if(session('gagal'))
