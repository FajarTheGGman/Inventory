        ...
        <div class='flex items-center flex-col'>
            ...
            @if( $data->count() == 0 )
                <div class='flex flex-col items-center'>
                    <a href='/admin/pengelola/input' class='bg-blue-700 flex justify-center place-self-center mt-10 p-2 rounded-xl'>Tambahkan Data</a>
                    <h1 class='text-center text-red-700 mt-5'>Master Data Kosong, Silahkan klik tombol di atas</h1>
                </div>
            @else
            <a href='/admin/pengelola/input' class='bg-blue-700 flex justify-start place-self-start mt-10 p-2 rounded-xl'>Tambahkan Data</a>
                    ...
                    <tbody class='p-10' border='1'>
                        <tr>
                            ...
                            <td class='pl-5 pr-5 pt-5 flex flex-row'>
                                <form action='/admin/pengelola/delete/{{ $x->id }}' method='post'>
                                    @csrf
