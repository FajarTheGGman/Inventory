...
@section('body')
    <div class='flex flex-col place-self-center bg-white p-5 rounded-xl shadow-xl mt-20'>
        ...
        <form action='/admin/kelompokaset/input/data' method='post' class='mt-5 flex flex-col'>
            @csrf
    ...
    <a href='/admin/kelompokaset' class='flex place-self-center mt-2 bg-yellow-600 p-2 rounded-xl mb-10'>Kembali</a>
@endsection
