        ...
        <div class='flex items-center flex-col'>
            ...
            @if( $data->count() == 0 )
                <div class='flex flex-col items-center'>
                    <a href='/admin/sumberdana/input' class='bg-blue-700 flex justify-center place-self-center mt-10 p-2 rounded-xl'>Tambahkan Data</a>
                    ...
                    <tbody class='p-10' border='1'>
                        <tr>
                            ...
                            <td class='pl-5 pr-5 pt-5 flex flex-row'>
                                <form action='/admin/sumberdana/delete/{{ $x->id }}' method='post'>
                                    @csrf
                                    <button type='submit' class='bg-red-700 p-2 rounded-xl'>Hapus</button>
                                    <a href='/admin/edit' class='ml-2 rounded-xl bg-yellow-600 p-2'>Edit</a>
                                </form>
                            </td>
                        </tr>
                    </tbody>
